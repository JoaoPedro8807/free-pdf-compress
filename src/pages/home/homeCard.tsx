...
export const HomeCard = ( {children, style, text, title} : HomeCardProps ) => {

  const elementsRef = useIntersectionObserver({threshold: 0}); // porcentagem de visibilidade pra ativar o intersect


  return (
    <StyledWrapper style={style} id='root'>
      <div className="section_our_solution hiddenCard" ref={element => element && elementsRef.current.push(element)}>
        <div className="row">
              ...
              <div className="solution_cards_box">
                <div className="solution_card">
                  ...
                  <div className="solu_description">
                    ...
                    <button className="read_more_btn"  type="button"><a href="#section-more-about" style={{ textDecoration: 'none', color: 'black'}} >Saiba mais</a></button>
                  </div>
                </div>
              </div>
            </div>
